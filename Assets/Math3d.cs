...
public class Math3d : MonoBehaviour {
    ...
    public static float DistancePointLine(Vector3 lineStart, Vector3 lineEnd, Vector3 point)
    {
        return Vector3.Magnitude(Math3d.ProjectPointOnLine(lineStart, lineEnd, point) - point);
    }
